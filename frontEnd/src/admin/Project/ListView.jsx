          ...
          {filteredProjects.map((project) => {
            ...
            return (
              ...
              >
                ...
                <td>
                  <div title={formatDate(project.startDate)}>{formatDate(project.startDate)}</div> - 
                  <div title={formatDate(project.endDate)}>{formatDate(project.endDate)}</div>
                </td>
                <td>
                  <select
                ...
                <td title={formatCurrency(project.contractPrice)}>{formatCurrency(project.contractPrice)}</td>
                <td title={formatCurrency(project.downpayment)}>{formatCurrency(project.downpayment)}</td>
                <td title={formatCurrency(totalTasks[project.id])}>{formatCurrency(totalTasks[project.id])}</td>
                ...
                <td>
                  <select
                    ...
                    className={`payment-status-dropdown ${paymentstatuses[project.id] === "Paid" ? "paid-status" : ""}`}
                    style={{
                      backgroundColor:
